...
const Introduction = () => {
    return (
        <Stack
            ...
            className="about-section justify-content-center align-items-center"
        >
            <Svg1 className="about-svg-decor-1" />

            <div className="about-content-box">
                <div className="about-badge">
                    <span>💡 ¿POR QUÉ MATE+?</span>
                </div>

                <h2 className="about-title">
                    Con MATE+ aprendés matemática útil, en minutos y sin vergüenza
                </h2>

                <p className="about-text">
                    A través de una experiencia interactiva y adaptada a tus necesidades, te ayudamos a ganar confianza en los números y recuperar tu autonomía financiera en el día a día.
                </p>
            </div>

            <Svg2 className="about-svg-decor-2" />
        </Stack>
    );
};
...
const Svg1 = ({ className }) => {
    return (
        <svg className={className} width="160" height="160" viewBox="0 0 201 201" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
...
const Svg2 = ({ className }) => {
    return (
        <svg className={className} width="150" height="150" viewBox="0 0 188 188" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
