    ...
    <>
      ...
      >
        <Container className="d-flex align-items-center px-4" style={{ justifyContent: 'space-between' }}>
          <Navbar.Brand onClick={() => navigate("/")} className="brand" style={{ cursor: "pointer" }}>
          ...
          <Navbar.Collapse id="navbar-nav" className="align-items-center justify-content-center">
            <Nav className="d-flex align-items-center gap-2 gap-lg-4 py-2 py-lg-0">
              ...
              {/* Botón Calculadora en el Header */}
              <button
                type="button"
                onClick={() => {
                  setExpanded(false);
                ...
                title="Calculadora Rápida: Realizá cuentas y operaciones cotidianas al instante"
              >
                <FaCalculator color="#0A3D91" size={13} />
                <div style={{ textAlign: "left", lineHeight: 1.1 }}>
                  <span>Calculadora</span>
                  <small style={{ display: "block", fontSize: "0.68rem", color: "#64748B", fontWeight: 500 }}>Cálculo rápido</small>
                </div>
              </button>

              {/* Botón Tutor Bot en el Header */}
              <button
                type="button"
                onClick={() => {
                  setExpanded(false);
                ...
                title="Tutor Bot IA: Tu asistente inteligente para resolver dudas y darte pistas"
              >
                <FaComments color="#2563EB" size={14} />
                <div style={{ textAlign: "left", lineHeight: 1.1 }}>
                  <span>Tutor Bot</span>
                  <small style={{ display: "block", fontSize: "0.68rem", color: "#3B82F6", fontWeight: 500 }}>Asistente IA</small>
                </div>
              </button>
            </Nav>
          </Navbar.Collapse>
